...
export const CONTENT: AppContent = {
  ...
  bonuses: {
    ...
    items: [
      { id: "b1", text: "קורס דיגיטלי מוקלט - 12 הדרכים - קורס תקשור", icon: <Sun /> },
      { id: "b2", text: "קורס דיגיטלי - קריאה בקלפים", icon: <BookOpen /> },
      { id: "b3", text: "הקלטות של מאחורי הקלעים של קריאה בקלפים", icon: <Film /> },
      { id: "b4", text: "הקלטות של כל שיעור", icon: <Video /> },
      { id: "b5", text: "קורס של הכשרת התקשור - תוכן שמתעדכן", icon: <Feather /> },
      { id: "b6", text: "פידבאק ומשוב עם כלים אישי בלייב לגבי היכולת תקשור שלך", icon: <Gem /> },
      { id: "b7", text: "בכל מפגש את מקבלת תקשור ונותנת תקשור", icon: <Infinity /> },
      { id: "b8", text: "ליווי בקבוצת וואצפ קבוצתית לאורך כל המסע", icon: <Users /> }
    ]
  },
  footer: {
